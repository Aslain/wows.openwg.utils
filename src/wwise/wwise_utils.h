...
namespace OpenWG::Utils::WWISE {
    ...
    template<class HashParams>
    typename HashParams::HashType
    FNVHash<HashParams>::Compute(const void *in_pData, typename HashParams::SizeType in_dataSize) {
        ...
        typename HashParams::HashType mask = static_cast<typename HashParams::HashType>(
